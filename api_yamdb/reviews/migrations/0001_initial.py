# Generated by Django 3.2 on 2023-06-29 13:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.SlugField(max_length=150, unique=True, verbose_name='Юзернейм пользователя')),
                ('email', models.SlugField(max_length=254, verbose_name='Email пользователя')),
                ('first_name', models.CharField(blank=True, max_length=150, verbose_name='Имя пользователя')),
                ('last_name', models.CharField(blank=True, max_length=150, verbose_name='Отчество пользователя')),
                ('bio', models.TextField(blank=True, verbose_name='Биография пользователя')),
                ('role', models.CharField(choices=[('U', 'user'), ('M', 'moderator'), ('A', 'admin')], default='U', max_length=2, verbose_name='Роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_reviews', to=settings.AUTH_USER_MODEL, verbose_name='Автор отзыва')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.title', verbose_name='Произведение')),
            ],
            options={
                'ordering': ['pub_date'],
            },
